...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:Danz Creator\n'
            + 'ORG:Owner DanzBot;\n'
            + 'TEL;type=CELL;type=VOICE;waid=6289686610207:+62 896-8661-0207\n'
            + 'END:VCARD'

prefix = ","
name = "🔱 DANZ BOT 🔱"
rdaftar = "TERIMA KASIH TELAH MENDAFTAR MENJADI BAGIAN DARI MEMBER DANZBOT ^_^"
rmenu = "HAI MEMBER DANZBOT👋, JANGAN LUPA DONASI YAA:)"
botinfo = "UNTUK INVITE BOT SILAHKAN DONASI DAHULU YAA:)"
limitt = 20
memberLimit = 2
ban = []
premium = ["6289686610207@s.whatsapp.net"]
...
async function starts() {
	...
	frhan.on('group-participants-update', async (anu) => {
		...
		try {
			...
			if (anu.action == 'add') {
				...
				teks = `[ *WELCOME IN GC ${mdata.subject}* ] \n*___________________________*\n@${num.split('@')[0]} Intro Dungs ^_^ \nNama : \nUmur : \nAskot : \nGender : \nnama instagram? (kalau perlu, kalau enggak yaudah skip aj ^_^)\n Save No Admin!\n *___________________________*\nSemoga betah Di group ye ^_^\n Notes : _Sesudah masuk grup, jangan lupa baca desc ya. . kalo mau nimbrung, nimbrung aja gak usah sok ngartis blok_ :)) \n  *TTD : ADMIN*`
				...
				teks = `SAYONARA... @${num.split('@')[0]}👋* \n_Hati-Hati Dijalan ye, semoga ga dipanggil sama Tuhan :D_`
				let buff = await getBuffer(ppimg)
				frhan.sendMessage(mdata.id, buff, MessageType.image, {caption: teks, contextInfo: {"mentionedJid": [num]}})
			}
		} catch (e) {
	...
	frhan.on('chat-update', async (mek) => {
		try {
			...
			const ZidanGans = ["0@s.whatsapp.net"] // ubah aja gapapa
			...
			const ownerNumber = ["6289686610207@s.whatsapp.net"] // owner number ubah aja
       ...
       if (messagesLink.includes("://chat.whatsapp.com/")){
		...
		setTimeout( () => {
		reply(`Link Group Terdeteksi maaf *${pushname2}* anda akan di kick dari grup..`)
		}, 0)
		}
		...
		case 'daftar':
			...
			if (!isPublic) return reply(mess.only.publikG)
                ...
                const tanggal = `${thisDay}, ${day} - ${myMonths[bulan]} - ${year}`
					await costum(help(prefix, instagram, yt, name, pushname2, user, limitt, uptime, jam, tanggal), text, ZidanGans, rmenu)
    				break 
    			case 'infobot':
    				await costum(bottt(prefix), text, ZidanGans, botinfo)
    				break
    			case 'profile':
    				frhan.updatePresence(from, Presence.composing)
    				if (!isPublic) return reply(mess.only.publikG)
...
//akhir kreator
		    ...
		    case 'map':
			    ...
			    if (!isPublic) return reply(mess.only.publikG)
					...
					mentions(`╔═══✪ Tag By *${pushname2}* ✪══`+ teks +'╚═══〘 DANZ BOT 〙═══', members_id, true)
					break
			    case 'mentionall':
			    if (isBanned) return reply(mess.only.benned)    
			    if (!isUser) return reply(mess.only.userB)
			    if (!isPublic) return reply(mess.only.publikG)
					...
					mentions(`╔══〘  *${body.slice(12)}*  〙✪══`+teks+'╚═〘 DANZ BOT 〙', members_id, true)
					break
			    case 'kbbi':
			    if (isBanned) return reply(mess.only.benned)    
			    if (!isUser) return reply(mess.only.userB)
...
frhan.sendMessage(from, irimp3, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'pale':
const pa = fs.readFileSync('assets/pale.mp3')
frhan.sendMessage(from, pa, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'sound':
const soun = fs.readFileSync('assets/sound.mp3')
frhan.sendMessage(from, soun, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break 
case 'sound1':
satu = fs.readFileSync('./assets/sound1.mp3');
frhan.sendMessage(from, satu, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'sound2':
dua = fs.readFileSync('./assets/sound2.mp3');
frhan.sendMessage(from, dua, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'sound3':
tiga = fs.readFileSync('./assets/sound3.mp3');
frhan.sendMessage(from, tiga, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'sound4':
empat = fs.readFileSync('./assets/sound4.mp3');
frhan.sendMessage(from, empat, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'sound5':
lima = fs.readFileSync('./assets/sound5.mp3');
frhan.sendMessage(from, lima, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'sound6':
enam = fs.readFileSync('./assets/sound6.mp3');
frhan.sendMessage(from, enam, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'sound7':
tujuh = fs.readFileSync('./assets/sound7.mp3');
frhan.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break	
case 'wib':
tujuh = fs.readFileSync('./assets/wib.mp3');
frhan.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'abangjago':
tujuh = fs.readFileSync('./assets/abangjago.mp3');
frhan.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'shopee':
tujuh = fs.readFileSync('./assets/shopee.mp3');
frhan.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'pagi':
tujuh = fs.readFileSync('./assets/pagi.mp3');
frhan.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'pota':
...
break
case 'potaimut':
tujuh = fs.readFileSync('./assets/potaimut.mp3');
frhan.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'haiphuthon':
tujuh = fs.readFileSync('./assets/haiphuthon.mp3');
frhan.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'yamete':
...
break
case 'avocados':
tujuh = fs.readFileSync('./assets/avocados.mp3');
frhan.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'sapeteam':
tujuh = fs.readFileSync('./assets/sapeteam.mp3');
frhan.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'despacifyp':
tujuh = fs.readFileSync('./assets/despacifyp.mp3');
frhan.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'rapbitch':
tujuh = fs.readFileSync('./assets/rapbitch.mp3');
frhan.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'kangcopet':
tujuh = fs.readFileSync('./assets/kangcopet.mp3');
frhan.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'bomaye':
tujuh = fs.readFileSync('./assets/bomaye.mp3');
frhan.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'jirolupat':
tujuh = fs.readFileSync('./assets/jirolupat.mp3');
frhan.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'tariksis':
tujuh = fs.readFileSync('./assets/tariksis.mp3');
frhan.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'cukuptau':
tujuh = fs.readFileSync('./assets/cukuptau.mp3');
frhan.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'bernyanyi':
...
break
case 'bimasop':
tujuh = fs.readFileSync('./assets/bimasop.mp3');
frhan.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'bukalah':
tujuh = fs.readFileSync('./assets/bukalah.mp3');
frhan.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'terpesona':
tujuh = fs.readFileSync('./assets/terpesona.mp3');
frhan.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'terpesona1':
tujuh = fs.readFileSync('./assets/terpesona1.mp3');
frhan.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'hbd':
tujuh = fs.readFileSync('./assets/hbd.mp3');
frhan.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'toxic':
tujuh = fs.readFileSync('./assets/toxic.mp3');
frhan.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'wikawika':
tujuh = fs.readFileSync('./assets/wikawika.mp3');
frhan.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'happy':
tujuh = fs.readFileSync('./assets/happy.mp3');
frhan.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'jarof':
tujuh = fs.readFileSync('./assets/jarof.mp3');
frhan.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'tenang':
tujuh = fs.readFileSync('./assets/tenang.mp3');
frhan.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'campuran':
tujuh = fs.readFileSync('./assets/campuran.mp3');
frhan.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'neinei':
tujuh = fs.readFileSync('./assets/neinei.mp3');
frhan.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'kumon':
tujuh = fs.readFileSync('./assets/kumon.mp3');
frhan.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'asede':
tujuh = fs.readFileSync('./assets/asede.mp3');
frhan.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'jawatoxic':
tujuh = fs.readFileSync('./assets/jawatoxic.mp3');
frhan.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'baka':
case 'onichan':
case 'bodoh':
frhan.sendPtt(from, './assets/baka.mp3', {quoted: mek, ptt:true})
				...
				default:
                  ...
                  reply(`Maaf Kak, Command *${prefix}${command}* Tidak Terdaftar Di Dalam Database *${prefix}menu*`)
					...
					if (isGroup && isSimi && budy != undefined) {
						...
						console.log(color('[DANZBOT]','aqua'), 'Command Tidak Terdaftar', color(sender.split('@')[0]))
					}
                           }
		} catch (e) {
